...
export default function Trial() {
    ...
    // function trial() { altering ? (document.body.className = document.body.className.replace("main-body", "main-body1"), setaltering(!altering)) : (document.body.className = document.body.className.replace("main-body1", "main-body"), setaltering(!altering)) }
